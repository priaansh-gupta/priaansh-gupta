def generate_projects_matrix_svg():
    ...
    # 15 exact projects categorized into 5 domain clusters
    clusters = [
        {
            "title": "🤖 Autonomous Robotics & Hardware",
            "color": "#00f0ff", # cyan
            "x": 40, "y": 70, "w": 380, "h": 270,
            "projects": [
    ...
    with open('priaansh-projects-matrix.svg', 'w', encoding='utf-8') as f:
        f.write("\n".join(svg))
    print("Generated priaansh-projects-matrix.svg successfully!")
